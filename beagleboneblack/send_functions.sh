...
readonly LeftCtrl=1
readonly LeftShift=2
readonly LeftAlt=4
readonly LeftGui=8
readonly RightCtrl=16
readonly RightShift=32
readonly RightAlt=64
readonly RightGui=128

# ascii   modifier.keycode
#
readonly -A AsciiToKey=(
    [BS]=0.42
    [HT]=0.43
    [$'\t']=0.43
    [LF]=0.40
